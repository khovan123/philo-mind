...
// Progress endpoints
chapterRouter.get("/progress/all", authGuard, (req, res) => controller.getAllChapterProgress(req, res));
chapterRouter.get("/:chapter/progress", authGuard, (req, res) => controller.getChapterProgress(req, res));
chapterRouter.put("/:chapter/nodes/:muc/progress", authGuard, (req, res) => controller.upsertChapterProgress(req, res));
