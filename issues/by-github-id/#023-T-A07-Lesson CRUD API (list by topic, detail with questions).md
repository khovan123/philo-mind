# T-A07: Lesson CRUD API (list by topic, detail with questions)

## GitHub Link

- Issue: [#23](https://github.com/khovan123/philo-mind/issues/23)
- State: done
...
- Updated at: 2026-06-03T10:50:11Z
- Closed at: 2026-06-03T10:50:11Z
...
- 2026-05-31: Synced from GitHub issue state. This local file exists so the plan has an auditable log for issue #23 / `T-A07`.
...
| GitHub issue | #23 |
| Task ID | T-A07 |
| Title | Lesson CRUD API (list by topic, detail with questions) |
| State | done |
| Local log path | `issues/by-github-id/#023-T-A07-Lesson CRUD API (list by topic, detail with questions).md` |
...
- Các trường output tối thiểu phải đủ để frontend render trực tiếp các AC: Published-only for users; markdown content.
...
- Issue này phải được triển khai trên branch riêng và PR phải link trực tiếp tới issue #23.
...
- Output cần expose field trực tiếp phục vụ AC: Published-only for users, markdown content.

## 6. Acceptance Criteria chi tiết

- [ ] Published-only for users: có bằng chứng kiểm chứng rõ ràng trong PR.
...
- [ ] Triển khai đầy đủ scope **Lesson CRUD API (list by topic, detail with questions)**; nối route hoặc middleware vào entrypoint thực tế.
...
- [ ] Đối chiếu kết quả với yêu cầu cốt lõi: Published-only for users, markdown content.
...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #23 / `T-A07`, beyond implementation process notes.
