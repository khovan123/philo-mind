...
- 2026-05-31: BMAD sprint-status sync checked GitHub issue #74 for `T-D08`. Current source-of-truth status: **OPEN**. Local log: `issues/by-github-id/#074-T-D08-Step 1 (Story Detail) & Step 2 (Cinematic Opening).md`.
