...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #40 / `T-B02`, beyond implementation process notes.
...
- PR description must link issue #40 and mention `T-B02`.
