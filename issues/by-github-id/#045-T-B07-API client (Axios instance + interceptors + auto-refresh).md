...
- Updated at: 2026-05-31T15:39:18Z
...
| GitHub issue | #45 |
| Task ID | T-B07 |
| Title | API client (Axios instance + interceptors + auto-refresh) |
| State | open |
| Local log path | `issues/by-github-id/#045-T-B07-API client (Axios instance + interceptors + auto-refresh).md` |
