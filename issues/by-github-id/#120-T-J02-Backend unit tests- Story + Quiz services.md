...
- Issue: [#120](https://github.com/khovan123/philo-mind/issues/120)
- State: open
- Track: J - Testing
- Type: testing
- Priority: medium
...
- Test suite phải chạy sau khi dependency `T-D03`, `T-A10` có contract ổn định.
...
- Issue này phải được triển khai trên branch riêng và PR phải link trực tiếp tới issue #120.
...
- [ ] Session lifecycle: có bằng chứng kiểm chứng rõ ràng trong PR.
- [ ] score calculation edge cases: có bằng chứng kiểm chứng rõ ràng trong PR.
...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #120 / `T-J02`, beyond implementation process notes.
...
- PR description must link issue #120 and mention `T-J02`.
