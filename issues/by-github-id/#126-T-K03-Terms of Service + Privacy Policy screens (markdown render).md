...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #126 / `T-K03`, beyond implementation process notes.
...
- Một màn hình/flow tại `/settings/legal` render được trạng thái loading, empty, error và success.
...
- User thao tác trên `/settings/legal`, thấy dữ liệu/render đúng, CTA chính chuyển sang bước kế tiếp hoặc cập nhật UI ngay.
