# T-D09: Step 3 (Role Selection) & Step 4 (Role Intro)
...
- Route đề xuất: `/story/[id]/role-selection` và `/story/[id]/role-intro`.
- Role Selection: Cho phép người dùng chọn một trong các nhân vật/vai trò để trải nghiệm câu chuyện.
- Role Intro: Giới thiệu chi tiết về vai trò đã chọn, các đặc điểm tâm lý, lý tưởng triết học của nhân vật đó.
...
- Dependency trước khi nối API thật: `T-D08`.
...
- [ ] Triển khai đầy đủ UI flow **T-D09: Step 3 (Role Selection) & Step 4 (Role Intro)** gồm loading, empty, error và interaction state phù hợp.
...
- 2026-05-31: BMAD sprint-status sync checked GitHub issue #75 for `T-D09`. Current source-of-truth status: **OPEN**. Local log: `issues/by-github-id/#075-T-D09-Step 3 (Role Selection) & Step 4 (Role Intro).md`.
