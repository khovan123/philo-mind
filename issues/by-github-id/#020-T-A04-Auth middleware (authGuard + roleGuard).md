...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #20 / `T-A04`, beyond implementation process notes.
...
- PR description must link issue #20 and mention `T-A04`.
