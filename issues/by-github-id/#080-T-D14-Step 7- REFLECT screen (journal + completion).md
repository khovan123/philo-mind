...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #80 / `T-D14`, beyond implementation process notes.

### User-facing outcome

Đầu ra là một phần tính năng hoàn chỉnh cho Step 7: REFLECT screen (journal + completion), có hành vi quan sát được qua UI, API hoặc test.
...
- Một màn hình/flow tại `/story/[id]/reflect` render được trạng thái loading, empty, error và success.
...
- User thao tác trên `/story/[id]/reflect`, thấy dữ liệu/render đúng, CTA chính chuyển sang bước kế tiếp hoặc cập nhật UI ngay.
...
- PR description must link issue #80 and mention `T-D14`.
