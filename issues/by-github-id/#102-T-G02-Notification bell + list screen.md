# T-G02: Notification bell + list screen

## GitHub Link

- Issue: [#102](https://github.com/khovan123/philo-mind/issues/102)
- State: open
...
- Milestone: Week 6
- Assignees: @kangdev03
- Updated at: 2026-06-01T05:30:28Z
...
- 2026-05-31: Synced from GitHub issue state. This local file exists so the plan has an auditable log for issue #102 / `T-G02`.
...
| GitHub issue   | #102                                                                |
| Task ID        | T-G02                                                               |
| Title          | Notification bell + list screen                                     |
| State          | open                                                                |
| Local log path | `issues/by-github-id/#102-T-G02-Notification bell + list screen.md` |
...
- UI phải thể hiện trực tiếp các AC: Unread count badge; mark-read; deep-link.

### UI/navigation contract đề xuất

| Tình huống   | Người dùng thao tác                                | Kết quả bắt buộc                                          |
| ------------ | -------------------------------------------------- | --------------------------------------------------------- |
| Mở màn hình  | User vào `/notifications` từ tab/card/link phù hợp | Render màn hình chính của Notification bell + list screen |
| Action chính | Bấm CTA/item chính                                 | Thực hiện submit/navigate/update state theo domain        |

## 4. Flow tích hợp

- Dependency trước khi nối API thật: `T-A15`, `T-B16`.
...
- Issue này phải được triển khai trên branch riêng và PR phải link trực tiếp tới issue #102.
...
- [ ] Unread count badge: có bằng chứng kiểm chứng rõ ràng trong PR.
- [ ] mark-read: có bằng chứng kiểm chứng rõ ràng trong PR.
- [ ] deep-link: có bằng chứng kiểm chứng rõ ràng trong PR.

## 7. Checklist triển khai

- [ ] Khảo sát screen/component dùng chung hiện có và tái sử dụng design tokens của repo.
- [ ] Triển khai đầy đủ UI flow **Notification bell + list screen** gồm loading, empty, error và interaction state phù hợp.
...
- [ ] Đối chiếu kết quả với yêu cầu cốt lõi: Unread count badge, mark-read, deep-link.
...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #102 / `T-G02`, beyond implementation process notes.
...
- PR description must link issue #102 and mention `T-G02`.
...
- 2026-05-31: BMAD sprint-status sync checked GitHub issue #102 for `T-G02`. Current source-of-truth status: **OPEN**. Local log: `issues/by-github-id/#102-T-G02-Notification bell + list screen.md`.
