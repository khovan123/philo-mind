...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #86 / `T-E04`, beyond implementation process notes.
...
- PR description must link issue #86 and mention `T-E04`.
