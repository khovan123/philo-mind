...
- Updated at: 2026-05-31T15:39:19Z
...
| GitHub issue | #46 |
| Task ID | T-B08 |
| Title | Auth Zustand store (login/register/logout/checkAuth) |
| State | open |
| Local log path | `issues/by-github-id/#046-T-B08-Auth Zustand store (login-register-logout-checkAuth).md` |
