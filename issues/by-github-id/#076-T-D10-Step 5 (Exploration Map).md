...
- Milestone: Week 5
- Assignees: @dklinh05
- Updated at: 2026-06-03T13:27:04Z
- Closed at: 2026-06-03T13:27:04Z
...
- Route đề xuất: `/story/[id]/map`.
- Exploration Map: Hiển thị bản đồ hành trình với các điểm khảo sát/khám phá, thể hiện bối cảnh không gian của câu chuyện và các khu vực tương tác tiếp theo.
...
- Dependency trước khi nối API thật: `T-D09`.
...
- [ ] Triển khai đầy đủ UI flow **T-D10: Step 5 (Exploration Map)** gồm loading, empty, error và interaction state phù hợp.
...
- 2026-05-31: BMAD sprint-status sync checked GitHub issue #76 for `T-D10`. Current source-of-truth status: **OPEN**. Local log: `issues/by-github-id/#076-T-D10-Step 5 (Exploration Map).md`.
