...
- Các trường output tối thiểu phải đủ để frontend render trực tiếp các AC: 4 perspectives; stance tracking.
...
- Dependency trước khi tích hợp: `T-F01`, `T-A04`.
...
- Issue này phải được triển khai trên branch riêng và PR phải link trực tiếp tới issue #94.
- Nếu phát hiện dependency chưa sẵn sàng, PR phải ghi rõ mock/contract tạm và điều kiện để chuyển sang integration thật.

## 5. Hành vi người dùng hoặc API cần đạt

- Client gọi endpoint dưới `/api/v1/scenarios` với input hợp lệ thì nhận response thành công đủ dữ liệu để render hoặc lưu state.
...
- Output cần expose field trực tiếp phục vụ AC: 4 perspectives, stance tracking.

## 6. Acceptance Criteria chi tiết

- [ ] 4 perspectives: có bằng chứng kiểm chứng rõ ràng trong PR.
- [ ] stance tracking: có bằng chứng kiểm chứng rõ ràng trong PR.
