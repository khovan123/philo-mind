...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #124 / `T-K01`, beyond implementation process notes.
...
- Một màn hình/flow tại `/settings` render được trạng thái loading, empty, error và success.
...
- User thao tác trên `/settings`, thấy dữ liệu/render đúng, CTA chính chuyển sang bước kế tiếp hoặc cập nhật UI ngay.
