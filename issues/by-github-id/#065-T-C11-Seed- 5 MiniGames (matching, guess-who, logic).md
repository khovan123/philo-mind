...
- Issue này phải được triển khai trên branch riêng và PR phải link trực tiếp tới issue #65.
...
- [ ] JSON config for each game type: có bằng chứng kiểm chứng rõ ràng trong PR.
...
> Added by BMAD Advanced Elicitation on 2026-05-31. This section defines the concrete product output expected from issue #65 / `T-C11`, beyond implementation process notes.
...
- PR description must link issue #65 and mention `T-C11`.
