...
- 2026-06-01: BMAD sprint-status sync checked GitHub issue #119 for `T-J01`. Current source-of-truth status: **OPEN**. Local log: `issues/by-github-id/#119-T-J01-Backend unit tests- Auth service.md`.
