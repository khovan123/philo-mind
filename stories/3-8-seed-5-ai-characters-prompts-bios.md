---
story_key: 3-8-seed-5-ai-characters-prompts-bios
github_issue: 62
github_url: https://github.com/khovan123/philo-mind/issues/62
task_id: T-C08
...
# Story 3-8-seed-5-ai-characters-prompts-bios: Seed: 5 AI Characters (prompts + bios)
...
Là developer của PhiloMind, tôi cần hoàn thành **Seed: 5 AI Characters (prompts + bios)** theo issue GitHub [#62](https://github.com/khovan123/philo-mind/issues/62) để deliverable của task `T-C08` có thể review, test và tích hợp độc lập trong monorepo.
...
- [ ] Triển khai artifact dùng chung cho **Seed: 5 AI Characters (prompts + bios)** tại package hoặc seed module phù hợp.
...
- [ ] Đối chiếu kết quả với yêu cầu cốt lõi: Socrates, Nietzsche, Kant, Confucius, Marx.
...
- GitHub issue: [#62](https://github.com/khovan123/philo-mind/issues/62)
- Task ID: `T-C08`
...
Hoàn thành **Seed: 5 AI Characters (prompts + bios)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------ | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #62. | Codex  |
