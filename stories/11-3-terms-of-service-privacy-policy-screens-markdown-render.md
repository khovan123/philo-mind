---
story_key: 11-3-terms-of-service-privacy-policy-screens-markdown-render
github_issue: 126
github_url: https://github.com/khovan123/philo-mind/issues/126
task_id: T-K03
...
# Story 11-3-terms-of-service-privacy-policy-screens-markdown-render: Terms of Service + Privacy Policy screens (markdown render)
...
Là developer của PhiloMind, tôi cần hoàn thành **Terms of Service + Privacy Policy screens (markdown render)** theo issue GitHub [#126](https://github.com/khovan123/philo-mind/issues/126) để deliverable của task `T-K03` có thể review, test và tích hợp độc lập trong monorepo.
...
- GitHub issue: [#126](https://github.com/khovan123/philo-mind/issues/126)
- Task ID: `T-K03`
...
- Estimate: 1h
- Labels: `track:K-admin`, `priority:low`, `type:frontend`
...
Hoàn thành **Terms of Service + Privacy Policy screens (markdown render)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------- | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #126. | Codex  |
