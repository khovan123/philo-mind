---
story_key: 2-7-api-client-RTK Query-instance-interceptors-auto-refresh
github_issue: 45
github_url: https://github.com/khovan123/philo-mind/issues/45
task_id: T-B07
...
# Story 2-7-api-client-RTK Query-instance-interceptors-auto-refresh: RTK Query API layer (baseQuery + reauth + token persistence)
...
Là developer của PhiloMind, tôi cần hoàn thành **RTK Query API layer (baseQuery + reauth + token persistence)** theo issue GitHub [#45](https://github.com/khovan123/philo-mind/issues/45) để deliverable của task `T-B07` có thể review, test và tích hợp độc lập trong monorepo.
...
- GitHub issue: [#45](https://github.com/khovan123/philo-mind/issues/45)
- Task ID: `T-B07`
...
Hoàn thành **RTK Query API layer (baseQuery + reauth + token persistence)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------ | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #45. | Codex  |
