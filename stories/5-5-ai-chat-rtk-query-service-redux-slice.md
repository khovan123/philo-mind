---
story_key: 5-5-ai-chat-rtk-query-service-redux-slice
github_issue: 87
...
# Story 5-5-ai-chat-rtk-query-service-redux-slice: AI Chat RTK Query service + Redux slice
...
Là developer của PhiloMind, tôi cần hoàn thành **AI Chat RTK Query service + Redux slice** theo issue GitHub [#87](https://github.com/khovan123/philo-mind/issues/87) để deliverable của task `T-E05` có thể review, test và tích hợp độc lập trong monorepo.
...
### Mục tiêu
Hoàn thành **AI Chat RTK Query service + Redux slice** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
