---
story_key: 3-11-seed-5-minigames-matching-guess-who-logic
github_issue: 65
github_url: https://github.com/khovan123/philo-mind/issues/65
task_id: T-C11
...
# Story 3-11-seed-5-minigames-matching-guess-who-logic: Seed: 5 MiniGames (matching, guess-who, logic)
...
Là developer của PhiloMind, tôi cần hoàn thành **Seed: 5 MiniGames (matching, guess-who, logic)** theo issue GitHub [#65](https://github.com/khovan123/philo-mind/issues/65) để deliverable của task `T-C11` có thể review, test và tích hợp độc lập trong monorepo.

## Acceptance Criteria

- [ ] JSON config for each game type

## Tasks/Subtasks

### Implementation

- [ ] Triển khai artifact dùng chung cho **Seed: 5 MiniGames (matching, guess-who, logic)** tại package hoặc seed module phù hợp.
...
- [ ] Đối chiếu kết quả với yêu cầu cốt lõi: JSON config for each game type.
...
- GitHub issue: [#65](https://github.com/khovan123/philo-mind/issues/65)
- Task ID: `T-C11`
...
Hoàn thành **Seed: 5 MiniGames (matching, guess-who, logic)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------ | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #65. | Codex  |
