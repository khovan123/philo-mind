---
story_key: 6-7-debate-argue-screen-stance-editor-preview
github_issue: 99
github_url: https://github.com/khovan123/philo-mind/issues/99
task_id: T-F07
...
# Story 6-7-debate-argue-screen-stance-editor-preview: Debate argue screen (stance + editor + preview)
...
Là developer của PhiloMind, tôi cần hoàn thành **Debate argue screen (stance + editor + preview)** theo issue GitHub [#99](https://github.com/khovan123/philo-mind/issues/99) để deliverable của task `T-F07` có thể review, test và tích hợp độc lập trong monorepo.
...
- GitHub issue: [#99](https://github.com/khovan123/philo-mind/issues/99)
- Task ID: `T-F07`
...
Hoàn thành **Debate argue screen (stance + editor + preview)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------ | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #99. | Codex  |
