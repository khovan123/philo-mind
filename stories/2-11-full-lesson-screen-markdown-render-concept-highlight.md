---
story_key: 2-11-full-lesson-screen-markdown-render-concept-highlight
github_issue: 49
github_url: https://github.com/khovan123/philo-mind/issues/49
task_id: T-B11
...
# Story 2-11-full-lesson-screen-markdown-render-concept-highlight: Full Lesson screen (markdown render + concept highlight)
...
Là developer của PhiloMind, tôi cần hoàn thành **Full Lesson screen (markdown render + concept highlight)** theo issue GitHub [#49](https://github.com/khovan123/philo-mind/issues/49) để deliverable của task `T-B11` có thể review, test và tích hợp độc lập trong monorepo.
...
- [ ] Triển khai đầy đủ UI flow **Full Lesson screen (markdown render + concept highlight)** gồm loading, empty, error và interaction state phù hợp.
...
- [ ] Đối chiếu kết quả với yêu cầu cốt lõi: Scroll progress, auto-save, bookmark.
...
- GitHub issue: [#49](https://github.com/khovan123/philo-mind/issues/49)
- Task ID: `T-B11`
...
Hoàn thành **Full Lesson screen (markdown render + concept highlight)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------ | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #49. | Codex  |
