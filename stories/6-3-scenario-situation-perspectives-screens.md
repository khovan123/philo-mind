---
story_key: 6-3-scenario-situation-perspectives-screens
github_issue: 95
github_url: https://github.com/khovan123/philo-mind/issues/95
task_id: T-F03
...
# Story 6-3-scenario-situation-perspectives-screens: Scenario SITUATION + PERSPECTIVES screens
...
Là developer của PhiloMind, tôi cần hoàn thành **Scenario SITUATION + PERSPECTIVES screens** theo issue GitHub [#95](https://github.com/khovan123/philo-mind/issues/95) để deliverable của task `T-F03` có thể review, test và tích hợp độc lập trong monorepo.
...
- [ ] Triển khai đầy đủ UI flow **Scenario SITUATION + PERSPECTIVES screens** gồm loading, empty, error và interaction state phù hợp.
...
- [ ] Đối chiếu kết quả với yêu cầu cốt lõi: Stance selector, swipeable perspective cards.
...
- GitHub issue: [#95](https://github.com/khovan123/philo-mind/issues/95)
- Task ID: `T-F03`
...
Hoàn thành **Scenario SITUATION + PERSPECTIVES screens** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------ | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #95. | Codex  |
