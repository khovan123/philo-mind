---
story_key: 7-2-notification-bell-list-screen
github_issue: 102
github_url: https://github.com/khovan123/philo-mind/issues/102
task_id: T-G02
...
# Story 7-2-notification-bell-list-screen: Notification bell + list screen
...
Là developer của PhiloMind, tôi cần hoàn thành **Notification bell + list screen** theo issue GitHub [#102](https://github.com/khovan123/philo-mind/issues/102) để deliverable của task `T-G02` có thể review, test và tích hợp độc lập trong monorepo.
...
- GitHub issue: [#102](https://github.com/khovan123/philo-mind/issues/102)
- Task ID: `T-G02`
...
- Declared dependencies: `T-A15`, `T-B16`
...
Hoàn thành **Notification bell + list screen** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| ---------- | ------- | ------------------------------------- | ------ |
| 2026-05-31 | 0.1     | Story created from GitHub issue #102. | Codex  |
