---
story_key: 2-7-api-client-axios-instance-interceptors-auto-refresh
github_issue: 45
...
# Story 2-7-api-client-axios-instance-interceptors-auto-refresh: API client (Axios instance + interceptors + auto-refresh)
...
Là developer của PhiloMind, tôi cần hoàn thành **API client (Axios instance + interceptors + auto-refresh)** theo issue GitHub [#45](https://github.com/khovan123/philo-mind/issues/45) để deliverable của task `T-B07` có thể review, test và tích hợp độc lập trong monorepo.
...
Hoàn thành **API client (Axios instance + interceptors + auto-refresh)** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
