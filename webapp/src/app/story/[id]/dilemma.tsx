...
export default function StoryDilemmaPlaceholderScreen() {
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.container}>
        <Card style={[styles.infoCard, { borderColor: theme.border }]}>
          <HelpCircle color={theme.primary} size={48} style={{ marginBottom: Spacing.three }} />
          ...
          <ThemedText type="small" themeColor="textSecondary" style={styles.description}>
            Đây là không gian hiển thị Tình huống nan giải và các Lựa chọn hành động (Story Choices)
            của nhân vật.
          </ThemedText>
