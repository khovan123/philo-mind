...
import { ArrowLeft, Bookmark, CheckCircle2, ChevronRight } from "lucide-react-native";
...
import { ConceptModal } from "./full_lesson/ConceptModal";
import type { ConceptName } from "./full_lesson/data";
import { fullLesson } from "./full_lesson/data";
import { FullLessonContent } from "./full_lesson/FullLessonContent";
import { Colors, styles } from "./full_lesson/ui";
...
export default function FullLessonScreen() {
  ...
  const progressLabel = useMemo(() => Math.min(100, Math.max(0, Math.round(progress * 100))), [progress]);
    ...
    <SafeAreaView edges={["top"]} style={styles.safeArea}>
      <View style={styles.screen}>
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            >
              <Bookmark
                ...
                fill={bookmarked ? Colors.primaryLight : "transparent"}
                size={21}
              />
            </Pressable>
          </View>
          ...
          <View style={{ gap: 6 }}>
            <ThemedText style={styles.progressLabel}>Reading progress: {progressLabel}%</ThemedText>
            <View style={styles.progressTrack}>
              <View style={[styles.progressFill, { width: `${progressLabel}%` }]} />
            </View>
          </View>
        </View>
        ...
        >
          <View style={styles.metaWrap}>
            <View style={styles.chipRow}>
              ...
              <View style={styles.chip}>
                <ThemedText style={styles.chipText}>{completed ? "Completed" : fullLesson.status}</ThemedText>
              </View>
            </View>
          ...
          <Image source={fullLesson.image} contentFit="cover" transition={220} style={styles.heroImage} />
