...
export default function ProfileScreen() {
  ...
  const currentStreak =
    (profileSummary.activity?.streak?.currentStreak ?? 0) > 0
      ? (profileSummary.activity?.streak?.currentStreak ?? 0)
      : 0;
  const longestStreak =
    (profileSummary.activity?.streak?.longestStreak ?? 0) > 0
      ? (profileSummary.activity?.streak?.longestStreak ?? 0)
      : 0;
