---
story_key: 3-6-seed-20-full-lessons-40-quiz-questions
github_issue: 60
github_url: https://github.com/khovan123/philo-mind/issues/60
task_id: T-C06
...
# Story 3-6-seed-20-full-lessons-40-quiz-questions: Seed: 20 Full Lessons + 40 Quiz Questions
...
Là developer của PhiloMind, tôi cần hoàn thành **Seed: 20 Full Lessons + 40 Quiz Questions** theo issue GitHub [#60](https://github.com/khovan123/philo-mind/issues/60) để deliverable của task `T-C06` có thể review, test và tích hợp độc lập trong monorepo.
...
### Source Issue
- GitHub issue: [#60](https://github.com/khovan123/philo-mind/issues/60)
- Task ID: `T-C06`
...
### Mục tiêu
Hoàn thành **Seed: 20 Full Lessons + 40 Quiz Questions** theo contract và convention hiện có của PhiloMind, tạo đầu ra có thể review và tích hợp độc lập.
...
| --- | --- | --- | --- |
| 2026-05-31 | 0.1 | Story created from GitHub issue #60. | Codex |
